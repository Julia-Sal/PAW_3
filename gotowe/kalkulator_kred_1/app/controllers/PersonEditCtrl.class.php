...
class PersonEditCtrl {
	...
	public function validateSave() {
		...
		$this->form->installment = getFromRequest('installment',true,'Błędne wywołanie aplikacji');
		...
		if (empty(trim($this->form->installment))) {
			getMessages()->addError('Wprowadź wartosc raty');
		}
	...
	public function action_personEdit(){
		...
		if ( $this->validateEdit() ){
			try {
				...
				$this->form->installment = $record['installment'];
